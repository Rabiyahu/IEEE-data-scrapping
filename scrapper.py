...
def extract_authors(driver, article_link):
    ...
    for author in author_elements:
        ...
        author_links.append(author.get_attribute('href'))
...
def extract_author_descriptions(driver, author_links):
    ...
    for link in author_links:
        ...
        description_elements = driver.find_elements(By.XPATH, '//*[@id="authorProfile"]/div[3]/div[1]/div/div[2]/div[1]')
...
def save_to_csv(file_path, data):
    ...
    with open(file_path, 'w', newline='', encoding='utf-8') as final_file:
        ...
        for row in data:
            writer.writerow([row[0], row[1], row[2], row[3].replace('\n', ' ')])
